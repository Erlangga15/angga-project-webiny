...
// Within both commands, we rely on the deployed GraphQL API (fullstack/api) and its stack
...
// - `fullstack/api/pulumi/dev/index.ts`
// - `fullstack/api/pulumi/prod/index.ts`
...
export default {
    commands: {
        async watch(options, context) {
            ...
            Object.assign(
                process.env,
                getStackOutput("fullstack/api", options.env, MAP)
            );
